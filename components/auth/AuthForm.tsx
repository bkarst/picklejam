 ...
 * /login·/signup·/forgot-password pages (UI §13.4). Email/password + Google/Apple
    ...
    <div className="flex flex-col gap-4">
      {mode !== "forgot" && (
        <div className="flex flex-col gap-2">
          ...
          <Button type="button" variant="outline" size="lg" fullWidth onPress={() => oauth(auth.signInWithApple)} isDisabled={busy}>
            Continue with Apple
          </Button>
